<template>
  <header class="h-24 z-10 px-6 md:px-10 flex justify-between items-center fixed top-0 left-0 w-full backdrop-blur-sm bg-theme-primary">
    ...
    <div class="md:hidden cursor-pointer" @click="toggleNavbar" v-if="!displayNavbar">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="#59e4a0">
    ...
    <ol class="hidden md:flex gap-1 font-fira items-center font-light">
        ...
        <li class="mx-1">
            ...
            <a class="p-2 pl-0 text-sm hover:text-secondary duration-500" href="#experience">Experience</a>
        </li>
        <li class="mx-1">
            <span class="text-secondary text-xs p-1 pr-0">03.</span>
            <a class="p-2 pl-0 text-sm hover:text-secondary duration-500" href="#work">Work</a>
        </li>
        <li class="mx-1">
