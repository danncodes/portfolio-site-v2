<template>
    <section class="fixed top-0 left-0 h-screen w-full z-[-1] md:hidden" :class="{'backdrop-blur-xl bg-opacity-50 z-40': displayNavbar}">
        ...
        <nav class="w-full max-w-xs h-screen shadow-2xl fixed top-0 right-0 duration-500 z-40 bg-[#112240]" :class="displayNavbar ? 'translate-x-0': 'translate-x-full' ">
            ...
            <ol class="h-3/6 w-full flex flex-col items-center justify-center font-fira">
                ...
                <li class="my-1 flex flex-col items-center">
                    ...
                    <a class="p-5 pt-0 text-primary-300 hover:text-secondary duration-500" href="#experience">Experience</a>
                </li>

                <li class="my-1 flex flex-col items-center">
                    <span class="text-secondary text-sm text-center">03.</span>
                    <a class="p-5 pt-0 text-primary-300 hover:text-secondary duration-500" href="#work">Work</a>
                </li>
