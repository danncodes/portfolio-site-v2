<template>
  <main class="h-[calc(100vh-6rem)] flex duration-200 pt-24">
    <section class="flex flex-col w-max lg:mx-10 xl:mx-20 h-4/5 justify-center duration-200">
      <h6 class="text-secondary font-fira mb-7 ml-1 duration-200">Introducing</h6>
      <h1 class="font-bold text-4xl md:text-5xl lg:text-6xl duration-200">Daniel Mensah.</h1>
      <h1 class="font-semibold text-3xl md:text-4xl lg:text-5xl mt-2 duration-200">Front-End Software Engineer</h1>
